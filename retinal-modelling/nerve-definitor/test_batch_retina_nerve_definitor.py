...
parser.add_argument("--pretrained", type=str,
                    default="training-data/retina-stuff-definitor/for-display/x64/checkpoints/states.pth",
...
parser.add_argument("--image-dir", type=str,
                    ...
                    # default="training-data/preprocess-output/kaggle-images",
...
def main():
    ...
    definitor = FcnskipNerveDefinitor2(num_classes=1, base=64).to(device)
